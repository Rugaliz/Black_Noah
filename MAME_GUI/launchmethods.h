...
public:
    ...
    void PC88 (std::string ROM_path_PC88_floppy1, std::string ROM_path_PC88_floppy2, std::string vertical_strech, std::string glsl_shader);
    ...
    void MegaDrive (std::string ROM_path_Genesis, std::string vertical_strech, std::string glsl_shader);
