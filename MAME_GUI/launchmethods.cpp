...
void LaunchMethods::MegaDrive (std::string ROM_path_Genesis, std::string vertical_strech, std::string glsl_shader) {
...
void LaunchMethods::Nintendo_NES (std::string ROM_path_NES, std::string vertical_strech, std::string glsl_shader) {
